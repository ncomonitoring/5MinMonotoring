...
public class APSE2_NcoWebClientSanity extends Base {
	...
	public void APSE_Netsfere_Message_Call_Check() throws InterruptedException, IOException , AWTException {		
		...
		HashMap<String , Integer> APSE2Vault_OldData_map = new HashMap<String, Integer>();	
		String APSE2VaultId = "";
		if( Config.getInstance().isDebug()) {
			APSE2VaultId = Config.getInstance().getAPSE2VaultId();
		} else {
			APSE2VaultId = Config.getInstance().getAPSE2VaultIdTest() ;
		}
		APSE2Vault_OldData_map =  NetsfereActivity.getVaultData(APSE2VaultId);
		//		APSE2Vault_OldData_map =  NetsfereActivity.getVaultData(Config.getInstance().getAPSE2VaultId());
		if(APSE2Vault_OldData_map.get("RC")  == 0  || APSE2Vault_OldData_map.get("RC")  == 2) {
			System.out.println("Conversations Acrchived Count :" + APSE2Vault_OldData_map.get("ConvCount"));
			System.out.println("Message Archive Count :"+APSE2Vault_OldData_map.get("MesgCount"));
			System.out.println("Report Generated Count :"+APSE2Vault_OldData_map.get("ReportCount") );
			//			System.out.println("Used Storage in MB :"+APSE2Vault_OldData_map.get("UsedStorage"));
			if(APSE2Vault_OldData_map.get("RC")  == 2 ) {
				System.out.println("Error in Logging out from Vault...");
			}
		} else if (APSE2Vault_OldData_map.get("RC")  == 1 ) { 
		...
		if( Config.getInstance().isDebug()) {
			webUserId = Config.getInstance().getAPSE2WebIdTest();
			webUserDisplayName = Config.getInstance().getAPSE2WebDisplayNameTest();
			chromeUserId = Config.getInstance().getAPSE2ChromeIdTest();
			chromeUserDisplayName = Config.getInstance().getAPSE2ChromeDisplayNameTest();
			firefoxUserId =  Config.getInstance().getAPSE2FirefoxIdTest();
			firefoxUserDisplayName = Config.getInstance().getAPSE2FirefoxDisplayNameTest();

		} else {
			webUserId = Config.getInstance().getAPSE2WebId();
			webUserDisplayName = Config.getInstance().getAPSE2WebDisplayName();
			chromeUserId = Config.getInstance().getAPSE2ChromeId();
			chromeUserDisplayName = Config.getInstance().getAPSE2ChromeDisplayName();
			firefoxUserId =  Config.getInstance().getAPSE2FirefoxId();
			firefoxUserDisplayName = Config.getInstance().getAPSE2FirefoxDisplayName();
		}
		// Login -- Web
		...
		HashMap<String , Integer> APSE2Vault_NewData_map = new HashMap<String, Integer>();	
		//			APSE2Vault_NewData_map = NetsfereActivity.getVaultData(Config.getInstance().getAPSE2VaultId());
		APSE2Vault_NewData_map = NetsfereActivity.getVaultData(APSE2VaultId);
		if(APSE2Vault_NewData_map.get("RC")  == 0  || APSE2Vault_NewData_map.get("RC")  == 2) {
			System.out.println("Conversations Acrchived Count :" + APSE2Vault_NewData_map.get("ConvCount"));
			System.out.println("Message Archive Count :"+APSE2Vault_NewData_map.get("MesgCount"));
			System.out.println("Report Generated Count :"+APSE2Vault_NewData_map.get("ReportCount") );
			//					System.out.println("Used Storage in MB :"+APSE2Vault_NewData_map.get("UsedStorage"));
			if(APSE2Vault_NewData_map.get("RC")  == 2 ) {
				System.out.println("Error in Logging out from Vault...");
			}
		} else if (APSE2Vault_NewData_map.get("RC")  == 1 ) { 
			System.out.println("Error in acccessing Vault....");
		}

		if ( APSE2Vault_NewData_map.get("MesgCount") > APSE2Vault_OldData_map.get("MesgCount") ) {
		...
		if ( APSE2Vault_NewData_map.get("ConvCount") > APSE2Vault_OldData_map.get("ConvCount")) {
		...
		//			if (APSE2Vault_NewData_map.get("ReportCount") > APSE2Vault_OldData_map.get("ReportCount")) {
		...
		//			}
		//			if ( APSE2Vault_NewData_map.get("UsedStorage")> APSE2Vault_OldData_map.get("UsedStorage")) {
